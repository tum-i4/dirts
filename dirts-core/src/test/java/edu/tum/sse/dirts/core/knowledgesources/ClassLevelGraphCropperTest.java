...
public class ClassLevelGraphCropperTest extends KnowledgeSourceTest {
    ...
    public void testUpdateBlackboard() {
        ...
        ClassLevelGraphCropper sut = new ClassLevelGraphCropper(blackboardMock, finderVisitorMock, Set.of(), t->true);
