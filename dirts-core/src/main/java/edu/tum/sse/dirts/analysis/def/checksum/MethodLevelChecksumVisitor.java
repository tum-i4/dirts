...
/**
 * Enables to calculate the checksum of method level nodes
 */
@SuppressWarnings({"unchecked", "rawtypes"})
public class MethodLevelChecksumVisitor implements ChecksumVisitor<BodyDeclaration<?>> {
    ...
    public MethodLevelChecksumVisitor() {
    ...
    /*
    Some elements are commented out, that are handled separately as method level nodes
    Other elements are commented out, because they do not change the runtime behavior of code
     */
    ...
    public Integer visit(final CompilationUnit n, final Void arg) {
        return n.getImports().accept(this, arg) * 31 +
                ...
                (n.getPackageDeclaration().isPresent() ? n.getPackageDeclaration().get().accept(this, arg) : 0) * 31 +
    ...
    public Integer visit(final MethodDeclaration n, final Void arg) {
        return (n.getBody().isPresent() ? n.getBody().get().accept(this, arg) : 0) * 31 +
                ...
                (n.getReceiverParameter().isPresent() ? n.getReceiverParameter().get().accept(this, arg) : 0) * 31 +
    ...
    public Integer visit(final ClassOrInterfaceType n, final Void arg) {
        return n.getName().accept(this, arg) * 31 +
                ...
                (n.getTypeArguments().isPresent() ? (Integer) ((NodeList) n.getTypeArguments().get()).accept(this, arg) : 0) * 31 +
                n.getAnnotations().accept(this, arg);
    }
    ...
    public Integer visit(final ExplicitConstructorInvocationStmt n, final Void arg) {
        return n.getArguments().accept(this, arg) * 31 +
                ...
                (n.isThis() ? 1 : 0) * 31 +
                (n.getTypeArguments().isPresent() ? (Integer) ((NodeList) n.getTypeArguments().get()).accept(this, arg) : 0);
    }
    ...
    public Integer visit(final ObjectCreationExpr n, final Void arg) {
        return (n.getAnonymousClassBody().isPresent() ? (Integer) ((NodeList) n.getAnonymousClassBody().get()).accept(this, arg) : 0) * 31 +
    ...
    public Integer visit(final SwitchEntry n, final Void arg) {
        return n.getLabels().accept(this, arg) * 31 +
