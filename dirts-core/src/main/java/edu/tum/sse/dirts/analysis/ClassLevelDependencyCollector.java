...
/**
 * Collects dependencies of class level nodes
 * <p>
 * Has to consider ClassOrInterfaceDeclaration, EnumDeclaration, AnnotationDeclaration
 */
public interface ClassLevelDependencyCollector extends DependencyCollector<TypeDeclaration<?>> {
    ...
    void visit(ClassOrInterfaceDeclaration n, DependencyGraph arg);

    void visit(EnumDeclaration n, DependencyGraph arg);

    void visit(AnnotationDeclaration n, DependencyGraph arg);
