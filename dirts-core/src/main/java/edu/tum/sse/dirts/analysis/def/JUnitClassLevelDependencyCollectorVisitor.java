 ...
 */
public class JUnitClassLevelDependencyCollectorVisitor
    ...
    public JUnitClassLevelDependencyCollectorVisitor(TestFilter<String, String> testFilter) {
    ...
    public void visit(ClassOrInterfaceDeclaration n, DependencyGraph dependencyGraph) {
        ...
        // Outer class is considered as test by MethodLevelTestFinderVisitor
        ...
        // Class is considered as test by MethodLevelTestFinderVisitor
        try {
