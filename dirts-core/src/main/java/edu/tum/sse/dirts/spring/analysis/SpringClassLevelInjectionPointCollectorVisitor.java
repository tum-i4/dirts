...
/**
 * Collects dependencies induced by Spring for class level nodes
 */
public class SpringClassLevelInjectionPointCollectorVisitor
        extends SpringInjectionPointCollectorVisitor<TypeDeclaration<?>>
        implements ClassLevelInjectionPointCollector {

    //##################################################################################################################
    // Methods inherited from ClassLevelInjectionPointCollector

    @Override
    public void visit(ClassOrInterfaceDeclaration n, InjectionPointStorage injectionPointStorage) {
        collectInjectionPoints(n, injectionPointStorage);
    }
    ...
    private void collectInjectionPoints(TypeDeclaration<?> n, InjectionPointStorage injectionPointStorage) {
        ...
        for (BodyDeclaration<?> injectedBodyDeclaration : injectedBodyDeclarations) {
            ...
            if (injectedBodyDeclaration.isFieldDeclaration()) {
                ...
                handleInjectionVariable(injectionPointStorage,
        ...
        handleGetBean(injectionPointStorage,
                n, x -> lookup(x.resolve()),
