 ...
 */
public class JUnitMethodLevelDependencyCollectorVisitor
    ...
    public JUnitMethodLevelDependencyCollectorVisitor(TestFilter<String, String> testFilter) {
    ...
    public void visit(ClassOrInterfaceDeclaration n, DependencyGraph dependencyGraph) {
        ...
        // Constructor of outer class is considered as test by MethodLevelTestFinderVisitor
        if (FinderVisitor.recursiveMemberTest(n, testFilter)) {
            for (BodyDeclaration<?> member : n.getMembers()) {
                if (member.isClassOrInterfaceDeclaration()) {
                    ClassOrInterfaceDeclaration innerClassOrInterfaceDeclaration =
                            member.asClassOrInterfaceDeclaration();

                    if (FinderVisitor.testClassDeclaration(innerClassOrInterfaceDeclaration, testFilter)
                            || ClassLevelNameFinderVisitor.recursiveMemberTest(innerClassOrInterfaceDeclaration, testFilter)) {
                        try {
        ...
        // Method is considered as test by MethodLevelTestFinderVisitor
        try {
            ResolvedReferenceTypeDeclaration resolvedReferenceTypeDeclaration = n.resolve();
    ...
    public void visit(MethodDeclaration n, DependencyGraph dependencyGraph) {
        if (FinderVisitor.testMethodDeclaration(n, testFilter)) {
            ...
            // Dependencies from methods annotated with @Before or similar
